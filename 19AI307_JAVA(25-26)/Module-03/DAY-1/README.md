...
## ALGORITHM :
1.	Start the program.
2.	Define a base class Customer with attributes customerId, name, and purchaseWeight.
3.	Define RegularCustomer subclass with a 2% discount on the gold rate.
4.	Define PremiumCustomer subclass with a 5% discount and 1% cashback on the final price.
5.	Input the base gold rate per gram at runtime.
6.	For each customer, calculate and display the final price (and cashback for premium).
...
## OUTPUT:
<img width="1290" height="746" alt="image" src="https://github.com/user-attachments/assets/42d69a74-7b17-40a9-b5f4-15c61eb9c4ce" />

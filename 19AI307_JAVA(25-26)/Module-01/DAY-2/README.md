...
Input : N, V1, and V2 (Follow the same order).

Output : Stairs if taking the stairs is faster, or Elevator if the elevator is the quicker option.

## AIM:
To write a Java program that determines whether using stairs or an elevator is faster based on given speeds and distance.

## ALGORITHM :
1.	Start the program.Start the program and create a Scanner object.
...
## OUTPUT:
<img width="1151" height="347" alt="image" src="https://github.com/user-attachments/assets/16a9861f-301d-4453-b75e-00cb22df7cd3" />
